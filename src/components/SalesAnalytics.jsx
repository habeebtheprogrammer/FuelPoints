...
function SalesAnalytics() {
  ...
  const loadCurrentReport = async () => {
    ...
    if (selectedStore) {
      queryParams.append('pdiStoreNumber', selectedStore);
    }
    ...
    queryParams.append('aggregate', 'false');
  ...
  return (
    <>
      ...
      {!dataLoading && !loading && filters.startDate && (() => {
        const hasData = 
          ...
          (selectedReport === 'unknownItems' && reports.unknownItems.length > 0) ||
